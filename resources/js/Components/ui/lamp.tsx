...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-b-3xl z-0",
                className
            )}
        >
            <svg
            ...
            <div className="relative flex w-full flex-1 scale-y-125 -mt-24 items-center justify-center isolate z-0 ">
                <motion.div

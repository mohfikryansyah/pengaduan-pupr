  ...
  return (
    <div className='bg-slate-900 w-full h-screen flex items-center justify-center'>
      <div className='text-center'>
        <h1 className='text-[8rem] text-white font-bold'>403</h1>
        <h1 className='text-3xl text-white font-bold mb-10'>Maaf, Anda tidak diizinkan untuk mengakses halaman ini.</h1>
